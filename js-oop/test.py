...
print(solution(0,0,10,10,-9,-9,1,1))
print(solution(0,0,10,10,-9,9,1,19))
print(solution(0,0,10,10,9,9,19,19))
print(solution(0,0,10,10,9,-9,19,1))
print(solution(0,0,10,10,10,10,20,20))